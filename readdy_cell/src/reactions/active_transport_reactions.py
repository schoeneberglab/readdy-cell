...
class ActiveTransportReactions:
    ...
    def register(self,
        ...
        system.topologies.add_spatial_reaction(
            ...
            rate=self.parameters["motor"]["kinesin"]["binding_rate"],
        ...
        system.topologies.add_structural_reaction(f'Step AT',
                                                  ...
                                                  rate_function=lambda x: 1.e-32, # Effefctively zero rate; triggered by engine
                                                  expect_connected=False)
    ...
    def get_add_active_transport2_reaction_function(self):
        ...
        def reaction_function_add_active_transport2(topology):
            ...
            recipe = readdy.StructuralReactionRecipe(topology)
            try:
                v_mito1 = topology.get_graph().get_vertices(vertex_type="mitochondria#AT-IM1", exact_match=True)[0]
    ...
    def get_add_active_transport3_reaction_function(self):
        ...
        def reaction_function_add_active_transport3(topology):
            ...
            vs_motor = topology.get_graph().get_vertices(vertex_type="motor#", exact_match=False)
            vs_tubulin = topology.get_graph().get_vertices(vertex_type="tubulin", exact_match=True)
            ...
            # Case 3: [N] Tubulin, [Y] Mitochondria, [Y] Motor --> Mitochondria#AT Complex
                ...
                if n_motors > 1:
                    vs_mito_at = topology.get_graph().get_vertices(vertex_type="mitochondria#terminal#AT", exact_match=True)
                    vs_mito_IM2 = topology.get_graph().get_vertices(vertex_type="mitochondria#AT-IM2", exact_match=True)
                ...
                v_mito_IM2 = topology.get_graph().get_vertices(vertex_type="mitochondria#AT-IM2", exact_match=True)[0]
